...
fun screen4(navController: NavController) {
    ...
    Box(
        ...
        Image(painter = painterResource(id = R.drawable.cricket),
        ...
        Column(
            ...
            Text(
                text = " EXITING SPORTS NEWS DAILY IN YOUR HAND ",
                style = TextStyle(fontSize = 30.sp), fontFamily = FontFamily.Serif
            )
            Spacer(modifier = Modifier.height(10.dp))

            Text(
                text = "know the exiting sports news around the world daily ",
