...
fun screen2(navController: NavController) {
    ...
    Box(
        ...
        Image(painter = painterResource(id = R.drawable.cryptonews),
        ...
        Column(
            ...
            Text(
                text = "     GET THE LATEST INVESTMENT UPDATES ",
                style = TextStyle(fontSize = 30.sp), fontFamily = FontFamily.Serif
            )
            Spacer(modifier = Modifier.height(10.dp))

            Text(
                text = "get ready to be notified with the trilling investment news ",
